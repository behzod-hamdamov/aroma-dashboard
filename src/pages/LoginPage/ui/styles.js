export const styles = {
  ...
  input: "border text-(--theme-color-secondary) border-(--border-color-login-form) rounded-sm p-[11px_16px] leading-5 text-[15px] font-(family-name:--font-roboto) placeholder:opacity-50 outline-0  focus:shadow-[0_0_0_3px_#b79f7c1a] focus:border-(--brand-color) duration-300",
  ...
  form: "w-full border border-(--border-color-login-form) p-10 flex flex-col gap-5 rounded-sm",
  form_btn: "leading-5 text-[15px] font-bold font-(family-name:--font-nunito) tracking-[0.3px] p-[12px_0] w-full bg-(--brand-color) text-white rounded-[3px] cursor-pointer",
