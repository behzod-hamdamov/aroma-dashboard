export const styles = {
  ...
  style_input_box: "flex flex-col gap-2 w-full",
  ...
  style_input_label: "leading-5.75 font-medium text-[14px] font-(family-name:font-roboto) text-(--theme-color-secondary)",
